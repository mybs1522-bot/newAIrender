...
const OnboardCard = ({
  ...
  return (
    ...
    >
      <div className="flex min-w-[250px] scale-[0.9] flex-col justify-center gap-2 rounded-md border bg-gradient-to-br from-neutral-100 to-neutral-50 py-2 pr-16 pl-3 opacity-80 dark:from-neutral-800 dark:to-neutral-950">
      ...
      <div className="flex min-w-[250px] flex-col justify-center gap-2 rounded-md border bg-gradient-to-br from-neutral-100 to-neutral-50 py-2 pr-16 pl-3 dark:from-neutral-800 dark:to-neutral-950">
      ...
      <div className="[background-image:linear-gradient(to_bottom,theme(colors.background)_20%,transparent_100%)] absolute top-0 h-[40%] w-full" />
      <div className="[background-image:linear-gradient(to_top,theme(colors.background)_20%,transparent_100%)] absolute bottom-0 h-[40%] w-full" />
    </div>
  );
};
